...
from airflow.models import DAG, Connection, settings
from airflow.operators.dummy_operator import DummyOperator
from airflow.operators.python_operator import BranchPythonOperator, PythonOperator
from airflow.utils.trigger_rule import TriggerRule
from airflow_sagemaker_dags import sagemaker_dag_config
...
from sagemaker.workflow.airflow import training_config, transform_config_from_estimator, tuning_config
...
def try_create_aws_conn(**kwargs):
    ...
    try:
        ...
        extra = json.dumps({"role_arn": sagemaker_dag_config.DAG_ROLE}, indent=2)
